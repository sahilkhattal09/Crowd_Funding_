...
function Verification() {
  ...
  const submitForm = async(e) =>{
    ...
    await axios.post(`http://localhost/finalYearProject/verification.php?id=${id}`,fd)
    .then((respo)=>{
      console.log(respo);
            ...
            <form action="/" onSubmit={handleSubmit( e => submitForm(e))} style={{borderRadius:"20px",marginTop:"20px",marginBottom:'20px',background:'#e9ecef',boxShadow:'0px 5px 10px 0px rgba(0, 0, 0, 0.3)'}}>
              <div className="colums">
                <div className="item">
                  ...
                  <input id="name" type="text" name="name" placeholder='Enter name of the patient'  {...register("name", {required: true})} onChange={e =>handleChange(e)}/>
                ...
                <div className="item">
                    ...
                    <input type="date" name="dob" className="custom-date-input" {...register("dob", {required: true})} onChange={e =>handleChange(e)} style={{height:'50%'}}/>
                ...
                <div className="item">
                    ...
                    <input id="Relation" type="text" name="Relation" placeholder='Enter Relationship with patient'  {...register("Relation", {required: true})} onChange={e =>handleChange(e)}/>
                ...
                <div className="item">
                    ...
                    <input id="address" type="text" name="address" placeholder='Enter address'  {...register("address", {required: true})} onChange={e =>handleChange(e)}/>
                    <p style={{color:'red',fontSize:'13px'}}>{errors.address?.type === "required" && "*Enter address"}</p>
                </div>

                <div className="item">
                    <label>Occupation:</label>
                    <input type="text"  name="occupation" className="form-control" placeholder="Enter Patient occupation"  {...register("occupation", {required: true})} onChange={e =>handleChange(e)}/>
